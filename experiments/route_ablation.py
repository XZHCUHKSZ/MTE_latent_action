"""X4. Compare an MTE auxiliary with a full-system auxiliary learning route.

Development experiment: two upstream seeds, nested decoder repeats. The MTE
training objective is the common full-visibility objective, not formal training.
"""
from pathlib import Path
import numpy as np
from mte.frontends import train
from utils.artifacts import data
from training.route_representation import train as train_mte
